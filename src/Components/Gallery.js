...
export const Gallery = ({gallery}) => {
  ...
  return (
    <>
    <div name="portfolio" className='max-w-[1366px] w-full mx-auto pt-[100px]'>
            <h1 className='text-center text-2xl md:text-4xl font-semibold mb-[20px] text-[#dcdcdc]'>PORTFOLIO</h1>
    </div>
    ...
    <div className='max-w-[1366px] mx-auto columns-1 sm:columns-2 md:columns-3 lg:columns-4 p-[20px]'>        
